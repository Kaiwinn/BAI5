package com.example.apppstore.adapter;
...
public class LoaiSpAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null){
            ...
            viewHolder.texttensp = view.findViewById(R.id.item_tensphammm);
            viewHolder.imghinhanh = view.findViewById(R.id.item_image);
            view.setTag(viewHolder);
        }else {
            viewHolder = (ViewHolder) view.getTag();
            viewHolder.texttensp.setText(array.get(i).getTensanpham());
            Glide.with(context).load(array.get(i).getHinnhanh()).into(viewHolder.imghinhanh);
        }
        return view;
